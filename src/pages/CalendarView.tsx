...
import { ChevronLeft, ChevronRight, Plus as PlusIcon, Loader2 } from 'lucide-react';
            ...
            <div className="flex items-center gap-2 min-w-max">
              ...
              {isGoogleConnected ? (
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-gray-200 dark:border-[#333] bg-white dark:bg-[#252525] text-xs font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#3d3c3e] transition-colors"
                >
                  {isGoogleLoading ? (
