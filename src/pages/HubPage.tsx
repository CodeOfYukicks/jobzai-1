    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-[#333234] dark:to-[#2b2a2c]">
      ...
      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-3 items-center h-16 lg:h-20">
              ...
              <motion.div 
                ...
                className="flex items-center gap-2 bg-gradient-to-r from-[#635BFF]/10 to-[#635BFF]/5 dark:from-[#635BFF]/20 dark:to-[#635BFF]/10 px-4 py-2 rounded-full w-fit"
              >
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
          ...
          {/* Navigation Grid - Compact 3 columns */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
