...
export default function Footer() {
  return (
    <footer className="bg-[#8D75E6] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            <Link to="/" className="inline-block hover:text-white transition-colors">
              <FirebaseImage 
                ...
                alt="Jobz.ai Logo" 
                className="h-16 w-auto" // Appropriate size for footer
              />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#features" className="text-gray-100 hover:text-white transition-colors">
                  Features
                </a>
              </li>
              <li>
                <a href="#pricing" className="text-gray-100 hover:text-white transition-colors">
                  Pricing
                </a>
              </li>
              <li>
                <a href="#how-it-works" className="text-gray-100 hover:text-white transition-colors">
                  How It Works
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/cookies" className="text-gray-100 hover:text-white transition-colors">
                  Cookie Policy
                </Link>
              </li>
            </ul>
