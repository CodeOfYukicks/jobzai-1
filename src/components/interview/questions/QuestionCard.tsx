  ...
  return (
    ...
    >
      ...
      <div className="
        ...
        hover:bg-slate-50/80 dark:hover:bg-[#3d3c3e]/20
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="flex-shrink-0 w-10 pt-0.5">
            <span className="
              ...
              w-9 h-9 rounded-xl
              text-sm font-bold
              bg-gradient-to-br from-slate-100 to-slate-50 dark:from-[#2b2a2c] dark:to-[#242325]
            ...
            <motion.button
              ...
              className={`
                ...
                ${isSaved
                  ...
                  : 'text-slate-400 dark:text-slate-500 hover:text-jobzai-600 dark:hover:text-jobzai-400 hover:bg-slate-100 dark:hover:bg-[#3d3c3e]'
                }
              `}
            >
            ...
            <div className="relative">
              <motion.button
                ...
                className="
                  ...
                  hover:bg-slate-100 dark:hover:bg-[#3d3c3e]
                  transition-all duration-200
                  ...
                  >
                    <button
                      ...
                      className="
                        ...
                        hover:bg-slate-50 dark:hover:bg-[#3d3c3e]
      ...
      <div className="h-px bg-gradient-to-r from-transparent via-slate-200 dark:via-[#2b2a2c] to-transparent mx-6" />
    </motion.article>
  );
});
