  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white dark:bg-[#2b2a2c] ring-1 ring-slate-200/60 dark:ring-[#3d3c3e]/60 hover:ring-jobzai-300/50 dark:hover:ring-jobzai-600/30 transition-all text-sm font-medium text-slate-700 dark:text-slate-300"
      >
            ...
            <>
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
                <motion.div
                  ...
                  className="w-full max-w-2xl max-h-[80vh] bg-white dark:bg-[#242325] rounded-2xl shadow-xl pointer-events-auto flex flex-col"
                >
              {/* Header */}
              <div className="flex items-center justify-between p-6 border-b border-slate-200/60 dark:border-[#3d3c3e]/60">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white">
                  Add Documents to Context
                </h3>
                <button
                  onClick={() => setIsOpen(false)}
                  className="p-2 hover:bg-slate-100 dark:hover:bg-[#3d3c3e] rounded-lg transition-colors"
                >
              ...
              {/* Tabs */}
              <div className="flex items-center gap-1 px-6 pt-4 border-b border-slate-200/60 dark:border-[#3d3c3e]/60">
                {[
              ...
              {/* Search */}
              <div className="p-4 border-b border-slate-200/60 dark:border-[#3d3c3e]/60">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-[#2b2a2c] border border-slate-200 dark:border-[#3d3c3e] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-jobzai-500/50 text-slate-900 dark:text-white"
                  />
                </div>
              </div>
