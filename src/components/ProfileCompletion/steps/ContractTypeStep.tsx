          ...
          <button
            ...
            className={`
              ...
              ${selectedContractType === id 
                ? 'bg-[#8D75E6]/10 dark:bg-[#8D75E6]/20 border-2 border-[#8D75E6] dark:border-[#7C3AED] dark:shadow-[0_0_0_1px_rgba(141,117,230,0.4),0_8px_16px_rgba(141,117,230,0.2)]' 
          ...
          >
            <div className="flex flex-col items-center text-center">
              <Icon className={`h-10 w-10 mb-4 transition-colors ${
                selectedContractType === id ? 'text-[#8D75E6] dark:text-[#A78BFA]' : 'text-gray-400 dark:text-gray-500 group-hover:text-[#8D75E6] dark:group-hover:text-[#A78BFA]'
              }`} />
              <span className={`font-medium text-lg transition-colors ${
                selectedContractType === id ? 'text-[#8D75E6] dark:text-[#A78BFA]' : 'text-gray-700 dark:text-gray-300'
              }`}>
                {label}
              </span>
            </div>
