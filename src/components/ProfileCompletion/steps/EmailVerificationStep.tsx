  ...
  return (
    <div className="max-w-xl mx-auto">
      <div className="text-center mb-8">
        <div className="mx-auto w-12 h-12 bg-[#635bff]/10 dark:bg-[#635bff]/20 rounded-full flex items-center justify-center mb-4">
          <Mail className="w-6 h-6 text-[#635bff] dark:text-[#A78BFA]" />
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border mb-6">
        ...
        <button
          ...
          disabled={timeLeft > 0}
          className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-[#635bff] dark:bg-[#7C3AED] text-white rounded-lg hover:brightness-110 dark:hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
