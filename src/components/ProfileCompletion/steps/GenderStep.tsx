      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          ...
          className={`p-4 rounded-lg border-2 transition-all duration-200 ${
            selectedGender === 'male'
              ? 'border-[hsl(var(--primary))] bg-[hsl(var(--primary))]/5 dark:bg-[hsl(var(--primary))]/10 dark:shadow-[0_0_0_1px_rgba(141,117,230,0.3),0_4px_12px_rgba(141,117,230,0.15)]'
              : 'border-gray-200 dark:border-gray-700 hover:border-[hsl(var(--primary))]/50 dark:hover:border-[hsl(var(--primary))]/50 bg-white dark:bg-gray-700/50 dark:shadow-[0_2px_4px_rgba(0,0,0,0.2)] hover:shadow-md dark:hover:shadow-[0_4px_8px_rgba(0,0,0,0.3)]'
          }`}
        >
          <User className="h-8 w-8 mx-auto mb-2 text-[hsl(var(--primary))]" />
