  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <input
            ...
            className={`w-full px-4 py-3 rounded-lg border-2 transition-all duration-200 ${
              errors.firstName
                ...
                : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-[#8D75E6] dark:focus:border-[#7C3AED] focus:ring-2 focus:ring-[#8D75E6]/20 dark:focus:ring-[#7C3AED]/20'
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className="w-full px-6 py-3 bg-[#8D75E6] dark:bg-[#7C3AED] text-white rounded-lg font-medium hover:bg-[#7D65D6] dark:hover:bg-[#6D28D9] transition-colors duration-200 shadow-lg hover:shadow-xl"
      >
        Continue
      </motion.button>
    </form>
