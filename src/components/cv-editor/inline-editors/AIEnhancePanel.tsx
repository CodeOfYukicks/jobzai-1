  ...
  return (
    <div className="mb-3">
      ...
      {!isExpanded && !suggestion && (
        ...
        >
          {/* Shimmer Background */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#EB7134] via-[#F59E0B] to-[#5D4D6B] opacity-90" />
      ...
      <AnimatePresence>
        {isExpanded && !suggestion && (
          ...
          >
            <div className="p-3 rounded-lg border border-[#EB7134]/20 bg-gradient-to-br from-[#EB7134]/5 to-[#5D4D6B]/5">
              {/* Header */}
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <div className="p-1 rounded-md bg-gradient-to-br from-[#EB7134] to-[#5D4D6B]">
                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        ${isActive 
                          ? 'border-[#EB7134] bg-[#EB7134]/10' 
                          : 'border-gray-200 dark:border-gray-700 hover:border-[#EB7134]/50 hover:bg-[#EB7134]/5'
                        }
                        disabled:opacity-50 disabled:cursor-not-allowed
                      `}
                    >
                      {isActive && isLoading ? (
                        <Loader2 className="w-4 h-4 text-[#EB7134] animate-spin" />
                      ) : (
                        <Icon className={`w-4 h-4 ${isActive ? 'text-[#EB7134]' : 'text-gray-500 group-hover:text-[#EB7134]'} transition-colors`} />
                      )}
                      <span className={`text-[10px] font-medium ${isActive ? 'text-[#EB7134]' : 'text-gray-600 dark:text-gray-400'}`}>
                        {action.label}
                      </span>
                    </button>
                  );
              ...
              <div className="flex gap-2">
                <div className="flex-1 relative">
                  <input
                    ...
                    disabled={isLoading}
                    className="w-full px-3 py-2 pr-8 text-xs bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#EB7134]/30 focus:border-[#EB7134] disabled:opacity-50"
                  />
                </div>
                <button
                  type="button"
                  ...
                  className="px-3 py-2 bg-gradient-to-r from-[#EB7134] to-[#5D4D6B] text-white rounded-lg hover:from-[#E85D04] hover:to-[#4D3D5B] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
      ...
      <AnimatePresence>
        {suggestion && (
          <motion.div
            ...
            className="overflow-hidden"
          >
            <div className="p-3 rounded-lg border-2 border-[#EB7134]/30 bg-gradient-to-br from-[#EB7134]/5 to-[#5D4D6B]/5">
              {/* Header */}
              ...
              <div className="flex items-center justify-between">
                <button
                  ...
                  className="flex items-center gap-1.5 px-2 py-1 text-xs text-gray-500 hover:text-[#EB7134] transition-colors"
                >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    onClick={handleApply}
                    className="flex items-center gap-1 px-3 py-1.5 text-xs font-semibold text-white bg-gradient-to-r from-[#EB7134] to-[#5D4D6B] rounded-lg hover:from-[#E85D04] hover:to-[#4D3D5B] shadow-md transition-all"
                  >
